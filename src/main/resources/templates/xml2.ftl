...
<#if prefixName??>
<#assign bean = conf.basePackage+"."+conf.beanPackage+"."+prefixName+"."+beanName/>
<#assign mapper = conf.basePackage+"."+conf.mapperPackage+"."+prefixName+"."+beanName+"Mapper"/>
<#else>
<#assign bean = conf.basePackage+"."+conf.beanPackage+"."+beanName/>
<#assign mapper = conf.basePackage+"."+conf.mapperPackage+"."+beanName+"Mapper"/>
</#if>
...
<mapper namespace="${mapper}">
    ...
    <sql id="searchInfoSql">
        ...
        `${fieldInfo.columnName}` AS  ${fieldInfo.beanName}<#if fieldInfo_has_next>,</#if>
        </#list>
    </sql>
